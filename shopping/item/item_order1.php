<?php
  ...
  if(!isset($_SESSION['buyer_ID'])) {
    ...
    //找到seller裡面符合seller_name='Andy'條件的項
    $ssql = "SELECT * FROM seller WHERE seller_name='Andy'";
    ...
    //找到stock裡面符合item_name='computer1'條件的項
    $itemsql = "SELECT * FROM stock WHERE item_name='computer1'";
