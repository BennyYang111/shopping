...
<head>
  <meta charset="utf-8">
  <title>【777鞋子系列】 高筒帆布鞋 TW 藍</title>
...
<body>
  ...
  <div role="main" class="container1">
    <div class="product-briefing flex card _2cRTS4">
      ...
      <center>
        <div class="qaNIZv">
          <span>【777鞋子系列】 高筒帆布鞋 TW 藍</span>
        </div>
        <br>
        <div class="flex items-center">
          <div class="_3n5NQx" style="font-size: 30px;">$880</div>
        </div>
      </center>
      <center>
        <div class="_1anaJP">
          <img src="../../img/shoes2.png" class=" item-img img-fluid" alt="">
        </div>
      </center>
      <center>
