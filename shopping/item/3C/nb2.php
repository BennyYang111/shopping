<?php
  ...
  $sql = "SELECT * FROM stock WHERE item_name='【777電腦系列】 筆記型電腦 冰河藍'";
  $result = $connect->query($sql);
  $row = $result->fetch_assoc();
  session_start();
  $_SESSION['item'] = '【777電腦系列】 筆記型電腦 冰河藍';
...
<body>
  ...
  <div role="main" class="container1">
    <div class="product-briefing flex card _2cRTS4">
      ...
      <center>
        <div class="qaNIZv">
          <span>【777電腦系列】 筆記型電腦 冰河藍</span>
        </div>
        <br>
        <div class="flex items-center">
          <div class="_3n5NQx" style="font-size: 30px;">$21,400</div>
        </div>
      </center>
      <center>
        <div class="_1anaJP">
          <img src="../../img/nb-2.jpg" class=" item-img img-fluid" alt="">
        </div>
      </center>
      <center>
        <div class="flex items-center _1FzU2Y">
          <div class="_2C2YFD">
            ...
            <div class="_2aZyWI">
              <div class="kIo6pj" style="font-size: 20px;">型號 : UX392FN
              </div>
