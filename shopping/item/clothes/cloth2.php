<?php
  ...
  $sql = "SELECT * FROM stock WHERE item_name='【777衣服系列】 T-shirt VANS'";
  $result = $connect->query($sql);
  $row = $result->fetch_assoc();
  session_start();
  $_SESSION['item'] = '【777衣服系列】 T-shirt VANS';
...
<head>
  <meta charset="utf-8">
  <title>【777衣服系列】 T-shirt VANS </title>
...
<body>
  ...
  <div role="main" class="container1">
    <div class="product-briefing flex card _2cRTS4">
      ...
      <center>
        <div class="qaNIZv">
          <span>【777衣服系列】 T-shirt VANS </span>
        </div>
        <br>
        <div class="flex items-center">
          <div class="_3n5NQx" style="font-size: 30px;">$800</div>
        </div>
      </center>
      <center>
        <div class="_1anaJP">
          <img src="../../img/cloth2.jpg" class=" item-img img-fluid" alt="">
        </div>
      </center>
      <center>
        <div class="flex items-center _1FzU2Y">
          <div class="_2C2YFD">
            ...
            <div class="_2aZyWI">
              ...
              <div class="kIo6pj" style="font-size: 20px;">品牌 : VANS</div>
