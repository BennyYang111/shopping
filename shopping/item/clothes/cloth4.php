<?php
  ...
  $sql = "SELECT * FROM stock WHERE item_name='【777衣服系列】 T-shirt 肌肉衣'";
  $result = $connect->query($sql);
  $row = $result->fetch_assoc();
  session_start();
  $_SESSION['item'] = '【777衣服系列】 T-shirt 肌肉衣';
...
<head>
  <meta charset="utf-8">
  <title>【777衣服系列】 T-shirt 肌肉衣 </title>
...
<body>
  ...
  <div role="main" class="container1">
    <div class="product-briefing flex card _2cRTS4">
      ...
      <center>
        <div class="qaNIZv">
          <span>【777衣服系列】 T-shirt 肌肉衣 </span>
        </div>
        <br>
        <div class="flex items-center">
          <div class="_3n5NQx" style="font-size: 30px;">$399</div>
        </div>
      </center>
      <center>
        <div class="_1anaJP">
          <img src="../../img/cloth4.jpg" class=" item-img img-fluid" alt="">
        </div>
      </center>
      <center>
